                            ...
                            <div class="module">
                                <div class="module-head">
                                    ...
                                    <div class="row pull-right">
                                        ...
                                        <a href="list_peserta_didik.php" class="btn btn-mini btn-primary"><i class="icon-backward"></i> Kembali</a>
                                    </div>
                                </div>
